...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Solusi cross-platform untuk menilai dan memantau aktivitas residensi serta catatan operasi dokter spesialis di FKUI.",
    longDescription: "Solusi cross-platform (aplikasi mobile dan website) yang dirancang untuk menilai dan memantau aktivitas residensi serta catatan operasi bagi dokter yang menempuh program spesialis di Fakultas Kedokteran, Universitas Indonesia. Fitur mencakup dashboard dengan profil pengguna, indikator level kompetensi, notifikasi persetujuan tertunda, pelacakan rotasi/stase, serta modul pelaporan untuk Laporan Kasus, Laporan Ilmiah, dan Laporan Ujian.",
    client: "Fakultas Kedokteran, Universitas Indonesia",
    date: "2024",
    techStack: ["ReactJS", "Flutter"],
    image: "https://ik.imagekit.io/cbadwplrt/portofolio/UI%20Anesthesia%20Logbook%20-%20Portfolio%20Visual-selection.png",
  },
  {
