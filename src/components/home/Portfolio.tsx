...
export function Portfolio() {
  ...
  return (
    <section id="klien" className="py-24 bg-offwhite-200 border-b border-charcoal-900/10 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        <div className="border-x border-charcoal-900/10 px-6 md:px-12 py-12">

          <div className="mb-16 md:flex justify-between items-end">
            <div className="max-w-2xl">
              <span className="uppercase tracking-widest text-terracotta text-xs font-semibold mb-4 block">Portofolio Terpilih</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <div className="relative aspect-4/5 bg-charcoal-800 mb-6 overflow-hidden songket-border-top songket-border-left">
                  <img
                    src={project.image}
                    alt={project.title}
                  ...
                  <div className="absolute top-6 left-6 z-10">
                    <span className="bg-offwhite-200/90 backdrop-blur-sm text-charcoal-900 px-3 py-1 text-[10px] font-bold uppercase tracking-widest border border-charcoal-900/10">
                      {project.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-start group">
                  <div>
                    <h3 className="text-xl font-semibold text-charcoal-900 mb-2 group-hover:text-terracotta transition-colors">
                      {project.title}
                    </h3>
                    <p className="text-sm text-charcoal-600 leading-relaxed max-w-[240px]">
                      {project.description}
                    </p>
                  </div>
