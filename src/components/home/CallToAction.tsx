  ...
  return (
    <section className="py-16 md:py-32 relative overflow-hidden bg-offwhite-200 border-b border-charcoal-900/10 font-sans">
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <span className="uppercase tracking-widest text-terracotta text-[10px] md:text-xs font-semibold mb-4 md:mb-6 block">Memulai Interaksi Sistem</span>
        <h2 className="text-2xl md:text-5xl font-light mb-6 md:mb-8 text-charcoal-900 tracking-tight leading-tight">Inisiasi Infrastruktur Digital Baru.</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-charcoal-900 hover:bg-charcoal-800 text-white px-8 md:px-10 py-4 md:py-5 font-medium text-xs md:text-sm transition-all shadow-sm uppercase tracking-widest">
