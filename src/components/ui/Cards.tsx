...
export function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="py-12 px-6 flex flex-col justify-center text-center group font-sans">
...
export function StructuralCard({ icon, title, desc }: { icon: ReactNode; title: string; desc: string }) {
  return (
    <motion.div variants={fadeUp} className="bg-white p-10 border border-charcoal-900/5 hover:border-charcoal-900/20 group transition-all duration-300 relative z-10 hover:-translate-y-1 shadow-sm hover:shadow-lg font-sans">
