      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-offwhite-200/95 backdrop-blur-sm border-b border-charcoal-900/10 transition-all">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-14 md:h-24 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="https://wa.me/6285117306806?text=Halo%20BKTech%2C%20saya%20ingin%20berkonsultasi%20mengenai%20pembuatan%20website%20untuk%20bisnis%20saya.%20Mohon%20informasi%20lebih%20lanjut." target="_blank" rel="noopener noreferrer" className="hidden sm:block bg-charcoal-900 text-white px-5 md:px-6 py-2.5 md:py-3 font-semibold text-xs md:text-sm transition-colors hover:bg-terracotta shadow-sm uppercase tracking-widest">
              Konsultasi
            </a>
            <button
          ...
          <>
            ...
            >
              ...
              <div className="mt-auto mb-10">
                <a href="https://wa.me/6285117306806?text=Halo%20BKTech%2C%20saya%20ingin%20berkonsultasi%20mengenai%20pembuatan%20website%20untuk%20bisnis%20saya.%20Mohon%20informasi%20lebih%20lanjut." target="_blank" rel="noopener noreferrer" className="w-full bg-charcoal-900 text-white py-4 font-bold text-xs uppercase tracking-[0.2em] shadow-lg hover:bg-terracotta transition-colors text-center">
                  Mulai Konsultasi
                </a>
              </div>
